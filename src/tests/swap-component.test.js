...
describe('Swap Component', function () {
     ...
     * SwapComponent Tests
     */
    describe('SwapComponent', function () {
        ...
        it('should render in active state correctly', function () {
        ...
        it('should handle disabled state correctly', function () {
        ...
        it('should handle size attribute correctly', function () {
        ...
        it('should toggle state when clicked', function () {
            sandbox.innerHTML = fixtures.basicSwap;
            const swap = document.getElementById('test-swap');
            const container = swap.querySelector('div[role="button"]');
        ...
        it('should dispatch custom event when toggled', function () {
            sandbox.innerHTML = fixtures.basicSwap;
            const swap = document.getElementById('test-swap');
            const container = swap.querySelector('div[role="button"]');
